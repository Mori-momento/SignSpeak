...
joblib.dump(svm_pipeline, 'asl_landmark_svm.joblib')
print("Saved SVM model to asl_landmark_svm.joblib")
...
torch.save(cnn_model.state_dict(), 'asl_landmark_cnn.pth')
print("Saved CNN model to asl_landmark_cnn.pth")
